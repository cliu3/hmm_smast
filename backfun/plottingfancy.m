function plottingfancy(day,result,td,cmapfancy,rate,mpt,zm,lock)
%PLOTTINGFANCY Plot, in a fancy way, the result of a geolocation.
%
...
set(gca,'position',[0.2 0.07 0.74 0.73]);
